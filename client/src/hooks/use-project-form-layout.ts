...
export interface ProjectFormLayoutItemFull { id: number; itemType: "field" | "custom_field" | "block" | "label"; itemKey: string; width: "full" | "half" | "third"; position: number; displayName: string | null; }
