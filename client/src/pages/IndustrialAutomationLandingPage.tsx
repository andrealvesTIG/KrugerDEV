...
import { Check, Menu, X, Mail, Loader2, CheckCircle, ChevronRight, Shield, Building2, Users, BarChart3, Clock, Target, Cpu, Activity, FileCheck, Layers, ArrowRight, Zap, TrendingUp, AlertTriangle, Settings, Wrench } from "lucide-react";
...
const painPoints = [
  {
    icon: Settings,
    title: "Plant Modernization Complexity",
    description: "Coordinate legacy system replacements, DCS migrations, and brownfield upgrades across multiple facilities without disrupting ongoing operations.",
    color: "text-cyan-600 bg-cyan-100 dark:bg-cyan-900/40 dark:text-cyan-400",
  },
  {
    icon: Cpu,
    title: "SCADA/ICS Upgrade Coordination",
    description: "Manage complex control system upgrades with full dependency tracking, vendor coordination, and integration testing across distributed plant architectures.",
    color: "text-slate-600 bg-slate-100 dark:bg-slate-900/40 dark:text-slate-400",
  },
  {
    icon: Shield,
    title: "Safety System Compliance",
    description: "Track IEC 61508 SIL verification, safety instrumented system assessments, and functional safety milestones with audit-ready documentation.",
    color: "text-rose-600 bg-rose-100 dark:bg-rose-900/40 dark:text-rose-400",
  },
  {
    icon: Building2,
    title: "Multi-Site Rollout Management",
    description: "Orchestrate automation deployments across geographically distributed plants with standardized templates, resource sharing, and centralized reporting.",
...
const features = [
  {
    icon: Layers,
    title: "Portfolio Oversight for Automation Programs",
    description: "See every automation initiative across your enterprise in one view — from SCADA modernizations to MES rollouts to safety system upgrades.",
    image: networkImage,
  },
  {
    icon: AlertTriangle,
    title: "AI-Powered Risk Detection for Control System Upgrades",
    description: "Our AI continuously monitors your project portfolio for schedule risks, integration conflicts, and resource bottlenecks — alerting you before small issues become costly plant shutdowns.",
    image: safetyImage,
  },
  {
    icon: FileCheck,
    title: "Safety Compliance Tracking (IEC 61508)",
    description: "Track SIL verification milestones, functional safety assessments, and regulatory requirements alongside your regular projects. Never miss a safety compliance deadline again.",
    image: heroImage,
  },
];
...
const useCases = [
  {
    ...
    description: "Plan multi-phase SCADA upgrades with dependency mapping, integration testing schedules, and automated status reporting to plant leadership.",
    icon: Cpu,
  },
  {
    title: "PLC Migration Programs",
    description: "Track PLC hardware replacements, I/O mapping, program conversions, and commissioning across multiple production lines simultaneously.",
    icon: Wrench,
  },
  {
    title: "Safety Instrumented System (SIS) Upgrades",
    description: "Manage SIL-rated system replacements with rigorous milestone tracking, vendor deliverables, and functional safety documentation requirements.",
    icon: Shield,
  },
  {
    title: "MES Implementation",
    description: "Coordinate Manufacturing Execution System deployments across sites with resource planning, integration testing, and executive dashboards.",
    icon: TrendingUp,
  },
];
...
export default function IndustrialAutomationLandingPage() {
  ...
  const handleGoogleSignIn = () => {
    window.location.href = "/api/auth/google/login?source=industrial-automation";
  };

  const handleMicrosoftSignIn = () => {
    window.location.href = "/api/auth/microsoft/login?source=industrial-automation";
  };
  ...
  const scrollToSignUp = () => {
    document.getElementById('automation-signup')?.scrollIntoView({ behavior: 'smooth' });
  };

  useEffect(() => {
    const prevTitle = document.title;
    document.title = "Industrial Automation Project Management Software | FridayReport.AI";
    ...
    const descContent = "AI-powered project portfolio management built for industrial automation. Track SCADA modernizations, PLC migrations, safety system upgrades, and MES implementations. Free forever.";
    upsertMeta("name", "description", descContent);
    upsertMeta("property", "og:title", "Industrial Automation Project Management Software | FridayReport.AI");
    upsertMeta("property", "og:description", "AI-powered PMO software for industrial automation companies. Free forever.");
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="flex items-center justify-between gap-4 flex-wrap px-6 py-4 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <IndustrySolutionsMenu currentPath="/industrial-automation" />
            <Button
              variant="ghost"
              onClick={() => setLocation("/auth?source=industrial-automation")}
            >
              Log in
            </Button>
            <Button
        ...
        <div className="sm:hidden border-b border-border bg-background px-6 py-4 flex flex-col gap-3 sticky top-[65px] z-40">
          ...
          <div className="border-t border-border pt-3 flex flex-col gap-3">
            <Button
              ...
              onClick={() => { setLocation("/auth?source=industrial-automation"); setMobileMenuOpen(false); }}
            >
              Log in
            </Button>
            <Button
      ...
      <main>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-50 via-slate-50 to-background dark:from-cyan-950/30 dark:via-slate-950/20 dark:to-background" />
          ...
          <div className="relative px-6 md:px-12 lg:px-20 py-16 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl">
                <Badge className="mb-6 bg-cyan-100 text-cyan-800 hover:bg-cyan-100 dark:bg-cyan-900/50 dark:text-cyan-300 border-0 text-sm px-4 py-1.5">
                ...
                >
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-slate-600 dark:from-cyan-400 dark:to-slate-400">
                    Built for Industrial Automation
                  </span>
                </h1>
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl">
                  From SCADA modernizations and PLC migrations to safety system upgrades — manage your entire automation PMO with AI-powered oversight that catches risks before they become plant shutdowns.
                </p>
                <ul className="mt-8 space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <Check className="h-5 w-5 text-cyan-600 dark:text-cyan-400 mt-0.5 shrink-0" />
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl w-full">
                <div className="relative">
                  <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/20 to-slate-500/20 rounded-2xl blur-xl" />
                  <img
                    src={heroImage}
                    alt="Industrial automation control room dashboard"
        ...
        <section className="border-y border-border bg-muted/30">
          <div className="px-6 md:px-12 lg:px-20 py-10 max-w-[1400px] mx-auto">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground uppercase mb-6 text-center">
              Trusted by teams at leading automation & industrial organizations
            </p>
            <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
              ...
              <div className="flex items-center gap-2 opacity-60">
                ...
                <span className="text-sm font-medium text-muted-foreground">System Integrators</span>
              </div>
              <div className="flex items-center gap-2 opacity-60">
                <Settings className="h-6 w-6 text-muted-foreground" />
                <span className="text-sm font-medium text-muted-foreground">Process Industries</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
          <AnimatedSection className="text-center mb-16">
            <motion.div variants={fadeUp}>
              <Badge variant="outline" className="mb-4 text-sm">Automation PMO Challenges</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                Your Automation PMO Deserves Better Tools
              </h2>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Industrial automation companies manage dozens of concurrent modernization programs. Generic project tools were not designed for the complexity of control system operations.
              </p>
            </motion.div>
          </AnimatedSection>
          ...
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                  One Platform for Your Entire Automation Enterprise
                </h2>
                <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                  FridayReport.AI brings AI-powered portfolio management to industrial automation, giving you the visibility and control your leadership team needs.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {features.map((feature, i) => (
                <AnimatedSection key={i} className={cn("flex flex-col gap-10 lg:gap-16 items-center", i % 2 === 1 ? "lg:flex-row-reverse" : "lg:flex-row")}>
                  <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                    <div className="w-12 h-12 rounded-lg bg-cyan-100 dark:bg-cyan-900/40 flex items-center justify-center mb-5">
          ...
          <AnimatedSection className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {stats.map((stat, i) => (
              <motion.div key={i} variants={fadeUp} className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-slate-600 dark:from-cyan-400 dark:to-slate-400 mb-2">
                  {stat.value}
                </div>
        ...
        <section className="bg-gradient-to-br from-slate-900 via-cyan-950 to-slate-900 text-white">
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "var(--font-display)" }}>
                  Built for the Way Automation Delivers Projects
                </h2>
                <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
                  Whether you are modernizing SCADA systems, migrating PLCs, or upgrading safety systems — FridayReport.AI adapts to your workflow.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {useCases.map((useCase, i) => (
                <motion.div key={i} variants={fadeUp}>
                  <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300 h-full">
                    <CardContent className="p-8">
                      <div className="w-12 h-12 rounded-lg bg-cyan-500/20 flex items-center justify-center mb-5">
          ...
          <AnimatedSection className="text-center mb-12">
            <motion.div variants={fadeUp}>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                See why industrial automation PMOs choose FridayReport.AI over generic project management tools.
              </p>
            </motion.div>
          </AnimatedSection>
        ...
        <section className="bg-gradient-to-br from-cyan-50 via-slate-50 to-background dark:from-cyan-950/20 dark:via-slate-950/10 dark:to-background border-t border-border">
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" style={{ fontFamily: "var(--font-display)" }}>
                  Ready to Modernize Your Automation PMO?
                </h2>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Join industrial automation companies that have already streamlined their project management with AI-powered tools designed for the unique demands of control system programs.
                </p>
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-md w-full" id="automation-signup">
                <Card className="shadow-2xl border-border">
                  {emailSent ? (
                    ...
                    <>
                      <CardHeader className="text-center pb-4">
                        <div className="mx-auto w-14 h-14 rounded-full bg-cyan-100 dark:bg-cyan-900/40 flex items-center justify-center mb-4">
                          <Cpu className="h-7 w-7 text-cyan-600 dark:text-cyan-400" />
                        </div>
                        <CardTitle className="text-2xl font-bold">Start Free Today</CardTitle>
                        <CardDescription>
                          Get your automation PMO up and running in minutes
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-5">
                        <form onSubmit={handleSubmit} className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="automation-email" className="font-medium">Work Email</Label>
                            <Input
                              id="automation-email"
                              type="email"
                          ...
                          <div className="flex items-start gap-3 p-3 rounded-md bg-muted/50 border border-border">
                            <Checkbox
                              ...
                              className="mt-0.5"
                            />
                            <Label htmlFor="automation-terms" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                              I agree to the{" "}
                        ...
                        <p className="text-center text-sm text-muted-foreground pt-2">
                          ...
                          <Link href="/signin?source=industrial-automation" className="text-primary font-semibold hover:underline">
                            Sign in
                          </Link>
                        </p>
                      </CardContent>
        ...
        <div className="px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">Industrial Automation Project Management</span>
            </div>
            <div className="flex flex-wrap justify-center items-center gap-4">
              ...
              <span className="text-muted-foreground">|</span>
              <a href="/signup?source=industrial-automation" className="text-sm text-muted-foreground hover:text-foreground hover:underline">General Sign Up</a>
            </div>
          </div>
