...
import { Check, Menu, X, Mail, Loader2, CheckCircle, ChevronRight, Shield, Building2, Users, BarChart3, Clock, Target, Zap, Activity, FileCheck, Layers, ArrowRight, TrendingUp, AlertTriangle, Leaf } from "lucide-react";
...
import heroImage from "@/assets/energy/hero-energy-ops.png";
import networkImage from "@/assets/energy/energy-network.png";
import complianceImage from "@/assets/energy/compliance-dashboard.png";
...
const painPoints = [
  {
    ...
    description: "Coordinate massive grid upgrade programs spanning multiple regions, substations, and technology platforms with full portfolio visibility and real-time progress tracking.",
    color: "text-emerald-600 bg-emerald-100 dark:bg-emerald-900/40 dark:text-emerald-400",
  },
  {
    icon: Leaf,
    title: "Renewable Integration Programs",
    description: "Manage solar, wind, and battery storage deployments across distributed sites with dependency mapping, permitting timelines, and interconnection queue tracking.",
    color: "text-green-600 bg-green-100 dark:bg-green-900/40 dark:text-green-400",
  },
  {
    icon: Shield,
    title: "NERC/FERC Compliance",
    description: "Stay ahead of NERC CIP, FERC, and state regulatory requirements with built-in compliance milestone tracking and automated alerts before audit deadlines slip.",
    color: "text-teal-600 bg-teal-100 dark:bg-teal-900/40 dark:text-teal-400",
  },
  {
    icon: Users,
    title: "Capital Project Portfolio Management",
    description: "Balance resources and budgets across transmission, distribution, generation, and IT modernization initiatives with capacity planning and workload dashboards.",
    color: "text-lime-600 bg-lime-100 dark:bg-lime-900/40 dark:text-lime-400",
  },
];
...
const features = [
  {
    icon: Layers,
    title: "Portfolio Oversight for Utility Programs",
    description: "See every initiative across your utility in one view — from grid modernization and renewable deployments to smart meter rollouts and compliance programs.",
    image: networkImage,
  },
  {
    icon: AlertTriangle,
    title: "AI-Powered Risk Detection for Grid Projects",
    description: "Our AI continuously monitors your project portfolio for schedule risks, budget overruns, and resource conflicts — alerting you before small issues become costly outages or regulatory violations.",
    image: complianceImage,
  },
  {
    icon: FileCheck,
    title: "Regulatory Compliance Tracking (NERC CIP)",
    description: "Track NERC CIP milestones, FERC filing deadlines, state PUC requirements, and environmental permits alongside your capital projects. Never miss a compliance deadline again.",
    image: networkImage,
  },
];
...
const useCases = [
  {
    ...
    description: "Plan multi-phase grid upgrade programs with task dependencies, substation milestones, and automated status reporting to executive leadership and regulators.",
    icon: Zap,
  },
  {
    title: "Renewable Energy Deployments",
    description: "Track solar farm construction, wind turbine installations, and battery storage projects across multiple sites with permitting, procurement, and interconnection timelines.",
    icon: Leaf,
  },
  {
    title: "Smart Meter Rollouts",
    description: "Coordinate AMI deployments across service territories with vendor management, field crew scheduling, and customer communication tracking at scale.",
    icon: BarChart3,
  },
  {
    title: "Pipeline & Transmission Projects",
    description: "Manage pipeline integrity programs, transmission line upgrades, and right-of-way acquisitions with regulatory milestone tracking and multi-stakeholder coordination.",
    icon: TrendingUp,
  },
];
...
export default function EnergyLandingPage() {
  ...
  const scrollToSignUp = () => {
    document.getElementById('energy-signup')?.scrollIntoView({ behavior: 'smooth' });
  };

  useEffect(() => {
    const prevTitle = document.title;
    document.title = "Energy & Utilities Project Management Software | FridayReport.AI";
    ...
    const descContent = "AI-powered project portfolio management built for energy and utility companies. Track grid modernization, renewable deployments, NERC CIP compliance, and more. Free forever.";
    upsertMeta("name", "description", descContent);
    upsertMeta("property", "og:title", "Energy & Utilities Project Management Software | FridayReport.AI");
    upsertMeta("property", "og:description", "AI-powered PMO software for energy and utility companies. Free forever.");
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="flex items-center justify-between gap-4 flex-wrap px-6 py-4 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <Badge variant="outline" className="text-xs font-medium border-emerald-300 text-emerald-700 dark:text-emerald-400 dark:border-emerald-700">
      ...
      <main>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-green-50 to-background dark:from-emerald-950/30 dark:via-green-950/20 dark:to-background" />
          ...
          <div className="relative px-6 md:px-12 lg:px-20 py-16 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl">
                <Badge className="mb-6 bg-emerald-100 text-emerald-800 hover:bg-emerald-100 dark:bg-emerald-900/50 dark:text-emerald-300 border-0 text-sm px-4 py-1.5">
                ...
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl">
                  From grid modernization and renewable deployments to NERC CIP compliance — manage your entire energy PMO with AI-powered oversight that catches risks before they become outages.
                </p>
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl w-full">
                <div className="relative">
                  <div className="absolute -inset-4 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-2xl blur-xl" />
                  <img
                    src={heroImage}
                    alt="Energy utility project management dashboard"
        ...
        <section className="border-y border-border bg-muted/30">
          <div className="px-6 md:px-12 lg:px-20 py-10 max-w-[1400px] mx-auto">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground uppercase mb-6 text-center">
              Trusted by teams at leading energy & utility organizations
            </p>
            <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
              ...
              <div className="flex items-center gap-2 opacity-60">
                ...
                <span className="text-sm font-medium text-muted-foreground">Major Utilities</span>
              </div>
              <div className="flex items-center gap-2 opacity-60">
                <Leaf className="h-6 w-6 text-muted-foreground" />
                <span className="text-sm font-medium text-muted-foreground">Renewable Developers</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
          <AnimatedSection className="text-center mb-16">
            <motion.div variants={fadeUp}>
              <Badge variant="outline" className="mb-4 text-sm">Energy PMO Challenges</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                Your Energy PMO Deserves Better Tools
              </h2>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Energy companies manage billions in capital projects across complex regulatory environments. Generic project tools were not designed for the scale of utility operations.
              </p>
            </motion.div>
          </AnimatedSection>
          ...
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                  One Platform for Your Entire Utility Portfolio
                </h2>
                <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                  FridayReport.AI brings AI-powered portfolio management to energy and utilities, giving you the visibility and control your leadership team needs.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {features.map((feature, i) => (
                <AnimatedSection key={i} className={cn("flex flex-col gap-10 lg:gap-16 items-center", i % 2 === 1 ? "lg:flex-row-reverse" : "lg:flex-row")}>
                  <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                    <div className="w-12 h-12 rounded-lg bg-emerald-100 dark:bg-emerald-900/40 flex items-center justify-center mb-5">
          ...
          <AnimatedSection className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {stats.map((stat, i) => (
              <motion.div key={i} variants={fadeUp} className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-600 dark:from-emerald-400 dark:to-green-400 mb-2">
                  {stat.value}
                </div>
            ...
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "var(--font-display)" }}>
                  Built for the Way Energy Companies Deliver Projects
                </h2>
                <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
                  Whether you are modernizing the grid, deploying renewables, or preparing for a NERC audit — FridayReport.AI adapts to your workflow.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {useCases.map((useCase, i) => (
                <motion.div key={i} variants={fadeUp}>
                  <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300 h-full">
                    <CardContent className="p-8">
                      <div className="w-12 h-12 rounded-lg bg-emerald-500/20 flex items-center justify-center mb-5">
          ...
          <AnimatedSection className="text-center mb-12">
            <motion.div variants={fadeUp}>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                See why energy PMOs choose FridayReport.AI over generic project management tools.
              </p>
            </motion.div>
          </AnimatedSection>
        ...
        <section className="bg-gradient-to-br from-emerald-50 via-green-50 to-background dark:from-emerald-950/20 dark:via-green-950/10 dark:to-background border-t border-border">
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" style={{ fontFamily: "var(--font-display)" }}>
                  Ready to Modernize Your Energy PMO?
                </h2>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Join energy and utility organizations that have already streamlined their project management with AI-powered tools designed for the unique demands of the energy sector.
                </p>
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-md w-full" id="energy-signup">
                  ...
                  {emailSent ? (
                    ...
                    <>
                      <CardHeader className="text-center pb-4">
                        ...
                        <CardDescription>
                          Get your energy PMO up and running in minutes
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-5">
                        <form onSubmit={handleSubmit} className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="energy-email" className="font-medium">Work Email</Label>
                            <Input
                              id="energy-email"
                              type="email"
                          ...
                          <div className="flex items-start gap-3 p-3 rounded-md bg-muted/50 border border-border">
                            <Checkbox
                              ...
                              className="mt-0.5"
                            />
                            <Label htmlFor="energy-terms" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                              I agree to the{" "}
        ...
        <div className="px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">Energy & Utilities Project Management</span>
            </div>
