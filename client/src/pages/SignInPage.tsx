...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-800 via-slate-700 to-slate-800 overflow-x-hidden">
      ...
      <section className="relative pt-6 sm:pt-8 pb-6 sm:pb-8 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <section className="hidden sm:block py-10 sm:py-20 px-4 sm:px-6 lg:px-8 bg-slate-700/30" data-testid="section-feature-comparison-signin">
