...
import { Check, Menu, X, Mail, Loader2, CheckCircle, ChevronRight, Shield, Building2, Users, BarChart3, Clock, Target, Heart, Activity, FileCheck, Layers, ArrowRight, Zap, TrendingUp, AlertTriangle } from "lucide-react";
...
import iconStethoscope from "@/assets/healthcare/icon-stethoscope-chart.png";
import iconHospital from "@/assets/healthcare/icon-hospital-shield.png";
...
const painPoints = [
  {
    ...
    description: "Stay ahead of Joint Commission, CMS, and HIPAA audits with built-in compliance milestone tracking and automated alerts before deadlines slip.",
    color: "text-blue-600 bg-blue-100 dark:bg-blue-900/40 dark:text-blue-400",
  },
  {
    icon: Building2,
    title: "Capital Project Oversight",
    description: "Manage facility expansions, renovations, and equipment installations across multiple sites with full portfolio visibility and budget tracking.",
    color: "text-teal-600 bg-teal-100 dark:bg-teal-900/40 dark:text-teal-400",
  },
  {
    icon: Activity,
    title: "Clinical IT Rollouts",
    description: "Coordinate EHR migrations, telehealth expansions, and medical device integrations with real-time dependency mapping and risk detection.",
    color: "text-rose-600 bg-rose-100 dark:bg-rose-900/40 dark:text-rose-400",
  },
  {
    icon: Users,
    title: "Cross-Department Resource Allocation",
    description: "Balance clinical, IT, and administrative staff across competing initiatives with capacity planning and workload dashboards.",
...
const features = [
  {
    icon: Layers,
    title: "Portfolio Oversight for Health Systems",
    description: "See every initiative across your health system in one view — from capital projects to IT modernization to quality improvement programs.",
    image: networkImage,
  },
  {
    icon: AlertTriangle,
    title: "AI-Powered Risk Detection",
    description: "Our AI continuously monitors your project portfolio for schedule risks, budget overruns, and resource conflicts — alerting you before small issues become costly problems.",
    image: complianceImage,
  },
  {
    icon: FileCheck,
    title: "Compliance-Ready Project Tracking",
    description: "Track regulatory milestones, audit preparation tasks, and accreditation requirements alongside your regular projects. Never miss a compliance deadline again.",
    image: hospitalImage,
  },
];
...
const useCases = [
  {
    title: "EHR Implementations",
    description: "Plan multi-phase EHR rollouts with task dependencies, go-live checklists, and automated status reporting to leadership.",
    icon: Activity,
  },
  {
    title: "Facility Expansions",
    description: "Track construction timelines, vendor deliverables, and equipment procurement across multiple building projects simultaneously.",
    icon: Building2,
  },
  {
    title: "Regulatory Compliance Programs",
    description: "Manage Joint Commission preparation, HIPAA security assessments, and CMS Conditions of Participation with milestone-driven tracking.",
    icon: Shield,
  },
  {
    title: "Clinical Workflow Optimization",
    description: "Coordinate process improvement initiatives across departments with resource planning, outcome tracking, and executive dashboards.",
    icon: TrendingUp,
  },
];
...
export default function HealthcareLandingPage() {
  ...
  const handleGoogleSignIn = () => {
    window.location.href = "/api/auth/google/login?source=healthcare";
  };

  const handleMicrosoftSignIn = () => {
    window.location.href = "/api/auth/microsoft/login?source=healthcare";
  };
  ...
  const scrollToSignUp = () => {
    document.getElementById('healthcare-signup')?.scrollIntoView({ behavior: 'smooth' });
  };

  useEffect(() => {
    const prevTitle = document.title;
    document.title = "Healthcare Project Management Software | FridayReport.AI";
    ...
    const descContent = "AI-powered project portfolio management built for hospitals and health systems. Track capital projects, IT rollouts, compliance programs, and more. Free forever.";
    upsertMeta("name", "description", descContent);
    upsertMeta("property", "og:title", "Healthcare Project Management Software | FridayReport.AI");
    upsertMeta("property", "og:description", "AI-powered PMO software for hospitals and health systems. Free forever.");
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="flex items-center justify-between gap-4 flex-wrap px-6 py-4 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <IndustrySolutionsMenu currentPath="/healthcare" />
            <Button
              variant="ghost"
              onClick={() => setLocation("/auth?source=healthcare")}
            >
              Log in
            </Button>
            <Button
        ...
        <div className="sm:hidden border-b border-border bg-background px-6 py-4 flex flex-col gap-3 sticky top-[65px] z-40">
          ...
          <div className="border-t border-border pt-3 flex flex-col gap-3">
            <Button
              ...
              onClick={() => { setLocation("/auth?source=healthcare"); setMobileMenuOpen(false); }}
            >
              Log in
            </Button>
            <Button
      ...
      <main>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-teal-50 via-blue-50 to-background dark:from-teal-950/30 dark:via-blue-950/20 dark:to-background" />
          <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23009688\' fill-opacity=\'1\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} />
          <div className="relative px-6 md:px-12 lg:px-20 py-16 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl">
                <Badge className="mb-6 bg-teal-100 text-teal-800 hover:bg-teal-100 dark:bg-teal-900/50 dark:text-teal-300 border-0 text-sm px-4 py-1.5">
                ...
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl">
                  From capital projects and IT modernization to regulatory compliance — manage your entire healthcare PMO with AI-powered oversight that catches risks before they become crises.
                </p>
                <ul className="mt-8 space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <Check className="h-5 w-5 text-teal-600 dark:text-teal-400 mt-0.5 shrink-0" />
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl w-full">
                <div className="relative">
                  <div className="absolute -inset-4 bg-gradient-to-r from-teal-500/20 to-blue-500/20 rounded-2xl blur-xl" />
                  <img
                    src={heroImage}
                    alt="Healthcare project management dashboard"
        ...
        <section className="border-y border-border bg-muted/30">
          <div className="px-6 md:px-12 lg:px-20 py-10 max-w-[1400px] mx-auto">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground uppercase mb-6 text-center">
              Trusted by teams at leading healthcare & life sciences organizations
            </p>
            <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
              <img src={clientLogo3} alt="Roche" className="h-8 md:h-10 w-auto object-contain grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 dark:invert" />
              <img src={clientLogo4} alt="Pfizer" className="h-8 md:h-10 w-auto object-contain grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 dark:invert" />
              <div className="flex items-center gap-2 opacity-60">
                <Building2 className="h-6 w-6 text-muted-foreground" />
                <span className="text-sm font-medium text-muted-foreground">Leading Health Systems</span>
              </div>
              <div className="flex items-center gap-2 opacity-60">
                <Heart className="h-6 w-6 text-muted-foreground" />
                <span className="text-sm font-medium text-muted-foreground">Regional Hospitals</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
          <AnimatedSection className="text-center mb-16">
            <motion.div variants={fadeUp}>
              <Badge variant="outline" className="mb-4 text-sm">Healthcare PMO Challenges</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                Your Healthcare PMO Deserves Better Tools
              </h2>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Hospital systems manage hundreds of concurrent initiatives. Generic project tools were not designed for the complexity of healthcare operations.
              </p>
            </motion.div>
          </AnimatedSection>
          ...
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                  One Platform for Your Entire Health System
                </h2>
                <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                  FridayReport.AI brings AI-powered portfolio management to healthcare, giving you the visibility and control your leadership team needs.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {features.map((feature, i) => (
                <AnimatedSection key={i} className={cn("flex flex-col gap-10 lg:gap-16 items-center", i % 2 === 1 ? "lg:flex-row-reverse" : "lg:flex-row")}>
                  <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                    <div className="w-12 h-12 rounded-lg bg-teal-100 dark:bg-teal-900/40 flex items-center justify-center mb-5">
            ...
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "var(--font-display)" }}>
                  Built for the Way Healthcare Delivers Projects
                </h2>
                <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
                  Whether you are rolling out a new EHR, expanding a facility, or preparing for an audit — FridayReport.AI adapts to your workflow.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {useCases.map((useCase, i) => (
                <motion.div key={i} variants={fadeUp}>
                  <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300 h-full">
                    <CardContent className="p-8">
                      <div className="w-12 h-12 rounded-lg bg-teal-500/20 flex items-center justify-center mb-5">
          ...
          <AnimatedSection className="text-center mb-12">
            <motion.div variants={fadeUp}>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                See why healthcare PMOs choose FridayReport.AI over generic project management tools.
              </p>
            </motion.div>
          </AnimatedSection>
        ...
        <section className="bg-gradient-to-br from-teal-50 via-blue-50 to-background dark:from-teal-950/20 dark:via-blue-950/10 dark:to-background border-t border-border">
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" style={{ fontFamily: "var(--font-display)" }}>
                  Ready to Modernize Your Healthcare PMO?
                </h2>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Join healthcare organizations that have already streamlined their project management with AI-powered tools designed for the unique demands of health systems.
                </p>
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-md w-full" id="healthcare-signup">
                <Card className="shadow-2xl border-border">
                  {emailSent ? (
                    ...
                    <>
                      <CardHeader className="text-center pb-4">
                        <div className="mx-auto w-14 h-14 rounded-full bg-teal-100 dark:bg-teal-900/40 flex items-center justify-center mb-4">
                          <Heart className="h-7 w-7 text-teal-600 dark:text-teal-400" />
                        </div>
                        <CardTitle className="text-2xl font-bold">Start Free Today</CardTitle>
                        <CardDescription>
                          Get your healthcare PMO up and running in minutes
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-5">
                        <form onSubmit={handleSubmit} className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="healthcare-email" className="font-medium">Work Email</Label>
                            <Input
                              id="healthcare-email"
                              type="email"
                          ...
                          <div className="flex items-start gap-3 p-3 rounded-md bg-muted/50 border border-border">
                            <Checkbox
                              ...
                              className="mt-0.5"
                            />
                            <Label htmlFor="healthcare-terms" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                              I agree to the{" "}
                        ...
                        <p className="text-center text-sm text-muted-foreground pt-2">
                          ...
                          <Link href="/signin?source=healthcare" className="text-primary font-semibold hover:underline">
                            Sign in
                          </Link>
                        </p>
                      </CardContent>
        ...
        <div className="px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">Healthcare Project Management</span>
            </div>
            <div className="flex flex-wrap justify-center items-center gap-4">
              ...
              <span className="text-muted-foreground">|</span>
              <a href="/signup?source=healthcare" className="text-sm text-muted-foreground hover:text-foreground hover:underline">General Sign Up</a>
            </div>
          </div>
