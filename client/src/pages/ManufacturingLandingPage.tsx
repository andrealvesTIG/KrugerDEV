...
import { Check, Menu, X, Mail, Loader2, CheckCircle, ChevronRight, Shield, Building2, Users, BarChart3, Clock, Target, Factory, Activity, FileCheck, Layers, ArrowRight, Zap, TrendingUp, AlertTriangle, Package, Settings, Workflow } from "lucide-react";
...
import heroImage from "@/assets/manufacturing/hero-factory.png";
import networkImage from "@/assets/manufacturing/supply-chain-network.png";
import qualityImage from "@/assets/manufacturing/quality-dashboard.png";
import iconGear from "@/assets/manufacturing/icon-gear-check.png";
...
const painPoints = [
  {
    icon: Package,
    title: "New Product Introduction Delays",
    description: "Accelerate NPI programs with dependency tracking, milestone management, and real-time visibility across engineering, procurement, and production teams.",
    color: "text-orange-600 bg-orange-100 dark:bg-orange-900/40 dark:text-orange-400",
  },
  {
    icon: Building2,
    title: "Plant Expansion Coordination",
    description: "Manage complex facility buildouts, equipment installations, and production line commissioning across multiple sites with full portfolio oversight.",
    color: "text-amber-600 bg-amber-100 dark:bg-amber-900/40 dark:text-amber-400",
  },
  {
    icon: Shield,
    title: "Quality Management Programs",
    description: "Track ISO 9001 audits, corrective actions, and continuous improvement initiatives with compliance-ready milestone tracking and automated alerts.",
    color: "text-rose-600 bg-rose-100 dark:bg-rose-900/40 dark:text-rose-400",
  },
  {
    icon: Workflow,
    title: "Supply Chain Optimization",
    description: "Coordinate supplier qualification, logistics improvements, and digitization programs with cross-functional resource planning and risk detection.",
...
const features = [
  {
    icon: Layers,
    title: "Portfolio Oversight for Manufacturing Initiatives",
    description: "See every initiative across your manufacturing operation in one view — from new product introductions to plant expansions to quality improvement programs.",
    image: networkImage,
  },
  {
    icon: AlertTriangle,
    title: "AI-Powered Risk Detection for Production Timelines",
    description: "Our AI continuously monitors your project portfolio for schedule risks, budget overruns, and resource conflicts — alerting you before small issues shut down production lines.",
    image: qualityImage,
  },
  {
    icon: FileCheck,
    title: "ISO & Quality Compliance Tracking",
    description: "Track ISO 9001 milestones, audit preparation tasks, and quality management requirements alongside your regular projects. Never miss a compliance deadline again.",
    image: heroImage,
  },
];
...
const useCases = [
  {
    title: "New Product Introductions (NPI)",
    description: "Plan multi-phase NPI programs with task dependencies, design review gates, and automated status reporting to leadership across engineering and production.",
    icon: Package,
  },
  {
    title: "Plant Expansions & Relocations",
    description: "Track construction timelines, equipment procurement, production line commissioning, and workforce readiness across multiple facility projects simultaneously.",
    icon: Building2,
  },
  {
    title: "Quality Management (ISO 9001)",
    description: "Manage ISO certification preparation, internal audits, corrective action programs, and continuous improvement initiatives with milestone-driven tracking.",
    icon: Shield,
  },
  {
    title: "Supply Chain Digitization",
    description: "Coordinate ERP implementations, supplier portal rollouts, warehouse automation, and logistics optimization programs with resource planning and executive dashboards.",
    icon: TrendingUp,
  },
];
...
export default function ManufacturingLandingPage() {
  ...
  const handleGoogleSignIn = () => {
    window.location.href = "/api/auth/google/login?source=manufacturing";
  };

  const handleMicrosoftSignIn = () => {
    window.location.href = "/api/auth/microsoft/login?source=manufacturing";
  };
  ...
  const scrollToSignUp = () => {
    document.getElementById('manufacturing-signup')?.scrollIntoView({ behavior: 'smooth' });
  };

  useEffect(() => {
    const prevTitle = document.title;
    document.title = "Manufacturing Project Management Software | FridayReport.AI";
    ...
    const descContent = "AI-powered project portfolio management built for manufacturing operations. Track new product introductions, plant expansions, quality programs, and supply chain initiatives. Free forever.";
    upsertMeta("name", "description", descContent);
    upsertMeta("property", "og:title", "Manufacturing Project Management Software | FridayReport.AI");
    upsertMeta("property", "og:description", "AI-powered PMO software for manufacturing organizations. Free forever.");
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="flex items-center justify-between gap-4 flex-wrap px-6 py-4 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <IndustrySolutionsMenu currentPath="/manufacturing" />
            <Button
              variant="ghost"
              onClick={() => setLocation("/auth?source=manufacturing")}
            >
              Log in
            </Button>
            <Button
        ...
        <div className="sm:hidden border-b border-border bg-background px-6 py-4 flex flex-col gap-3 sticky top-[65px] z-40">
          ...
          <div className="border-t border-border pt-3 flex flex-col gap-3">
            <Button
              ...
              onClick={() => { setLocation("/auth?source=manufacturing"); setMobileMenuOpen(false); }}
            >
              Log in
            </Button>
            <Button
      ...
      <main>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-orange-50 via-amber-50 to-background dark:from-orange-950/30 dark:via-amber-950/20 dark:to-background" />
          <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23F37021\' fill-opacity=\'1\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} />
          <div className="relative px-6 md:px-12 lg:px-20 py-16 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl">
                <Badge className="mb-6 bg-orange-100 text-orange-800 hover:bg-orange-100 dark:bg-orange-900/50 dark:text-orange-300 border-0 text-sm px-4 py-1.5">
                ...
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl">
                  From new product introductions and plant expansions to quality compliance — manage your entire manufacturing PMO with AI-powered oversight that catches risks before they halt production.
                </p>
                <ul className="mt-8 space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <Check className="h-5 w-5 text-orange-600 dark:text-orange-400 mt-0.5 shrink-0" />
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl w-full">
                <div className="relative">
                  <div className="absolute -inset-4 bg-gradient-to-r from-orange-500/20 to-amber-500/20 rounded-2xl blur-xl" />
                  <img
                    src={heroImage}
                    alt="Manufacturing project management dashboard"
        ...
        <section className="border-y border-border bg-muted/30">
          <div className="px-6 md:px-12 lg:px-20 py-10 max-w-[1400px] mx-auto">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground uppercase mb-6 text-center">
              Trusted by teams at leading manufacturing organizations
            </p>
            <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
              ...
              <div className="flex items-center gap-2 opacity-60">
                ...
                <span className="text-sm font-medium text-muted-foreground">Global Manufacturers</span>
              </div>
              <div className="flex items-center gap-2 opacity-60">
                <Settings className="h-6 w-6 text-muted-foreground" />
                <span className="text-sm font-medium text-muted-foreground">Industrial Leaders</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
          <AnimatedSection className="text-center mb-16">
            <motion.div variants={fadeUp}>
              <Badge variant="outline" className="mb-4 text-sm">Manufacturing PMO Challenges</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                Your Manufacturing PMO Deserves Better Tools
              </h2>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Manufacturing operations manage hundreds of concurrent initiatives across multiple plants. Generic project tools were not designed for the complexity of manufacturing operations.
              </p>
            </motion.div>
          </AnimatedSection>
          ...
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                  One Platform for Your Entire Manufacturing Operation
                </h2>
                <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                  FridayReport.AI brings AI-powered portfolio management to manufacturing, giving you the visibility and control your leadership team needs.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {features.map((feature, i) => (
                <AnimatedSection key={i} className={cn("flex flex-col gap-10 lg:gap-16 items-center", i % 2 === 1 ? "lg:flex-row-reverse" : "lg:flex-row")}>
                  <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                    <div className="w-12 h-12 rounded-lg bg-orange-100 dark:bg-orange-900/40 flex items-center justify-center mb-5">
          ...
          <AnimatedSection className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {stats.map((stat, i) => (
              <motion.div key={i} variants={fadeUp} className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-600 dark:from-orange-400 dark:to-amber-400 mb-2">
                  {stat.value}
                </div>
        ...
        <section className="bg-gradient-to-br from-slate-900 via-orange-950 to-slate-900 text-white">
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "var(--font-display)" }}>
                  Built for the Way Manufacturing Delivers Projects
                </h2>
                <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
                  Whether you are launching a new product, expanding a plant, or preparing for an ISO audit — FridayReport.AI adapts to your workflow.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {useCases.map((useCase, i) => (
                <motion.div key={i} variants={fadeUp}>
                  <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300 h-full">
                    <CardContent className="p-8">
                      <div className="w-12 h-12 rounded-lg bg-orange-500/20 flex items-center justify-center mb-5">
                        <useCase.icon className="h-6 w-6 text-orange-400" />
                      </div>
          ...
          <AnimatedSection className="text-center mb-12">
            <motion.div variants={fadeUp}>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                See why manufacturing PMOs choose FridayReport.AI over generic project management tools.
              </p>
            </motion.div>
          </AnimatedSection>
        ...
        <section className="bg-gradient-to-br from-orange-50 via-amber-50 to-background dark:from-orange-950/20 dark:via-amber-950/10 dark:to-background border-t border-border">
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" style={{ fontFamily: "var(--font-display)" }}>
                  Ready to Modernize Your Manufacturing PMO?
                </h2>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Join manufacturing organizations that have already streamlined their project management with AI-powered tools designed for the unique demands of production operations.
                </p>
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-md w-full" id="manufacturing-signup">
                <Card className="shadow-2xl border-border">
                  {emailSent ? (
                    ...
                    <>
                      <CardHeader className="text-center pb-4">
                        <div className="mx-auto w-14 h-14 rounded-full bg-orange-100 dark:bg-orange-900/40 flex items-center justify-center mb-4">
                          <Factory className="h-7 w-7 text-orange-600 dark:text-orange-400" />
                        </div>
                        <CardTitle className="text-2xl font-bold">Start Free Today</CardTitle>
                        <CardDescription>
                          Get your manufacturing PMO up and running in minutes
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-5">
                        <form onSubmit={handleSubmit} className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="manufacturing-email" className="font-medium">Work Email</Label>
                            <Input
                          ...
                          <div className="flex items-start gap-3 p-3 rounded-md bg-muted/50 border border-border">
                            <Checkbox
                              ...
                              className="mt-0.5"
                            />
                            <Label htmlFor="manufacturing-terms" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                              I agree to the{" "}
                        ...
                        <p className="text-center text-sm text-muted-foreground pt-2">
                          ...
                          <Link href="/signin?source=manufacturing" className="text-primary font-semibold hover:underline">
                            Sign in
                          </Link>
                        </p>
                      </CardContent>
        ...
        <div className="px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">Manufacturing Project Management</span>
            </div>
            <div className="flex flex-wrap justify-center items-center gap-4">
              ...
              <span className="text-muted-foreground">|</span>
              <a href="/signup?source=manufacturing" className="text-sm text-muted-foreground hover:text-foreground hover:underline">General Sign Up</a>
            </div>
          </div>
