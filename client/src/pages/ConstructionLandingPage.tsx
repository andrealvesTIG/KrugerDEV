...
import { Check, Menu, X, Mail, Loader2, CheckCircle, ChevronRight, Shield, Building2, Users, BarChart3, Clock, Target, HardHat, Activity, FileCheck, Layers, ArrowRight, Zap, TrendingUp, AlertTriangle, Hammer, MapPin } from "lucide-react";
...
import iconCrane from "@/assets/construction/icon-crane-chart.png";
...
const painPoints = [
  {
    icon: MapPin,
    title: "Multi-Site Project Coordination",
    description: "Manage dozens of concurrent job sites with real-time progress tracking, milestone dependencies, and centralized reporting across your entire capital program.",
    color: "text-yellow-600 bg-yellow-100 dark:bg-yellow-900/40 dark:text-yellow-400",
  },
  {
    icon: Users,
    title: "Contractor & Vendor Management",
    description: "Track subcontractor deliverables, vendor timelines, and procurement schedules across all active projects with automated alerts when deadlines are at risk.",
    color: "text-amber-600 bg-amber-100 dark:bg-amber-900/40 dark:text-amber-400",
  },
  {
    icon: BarChart3,
    title: "Budget Overrun Visibility",
    description: "Get instant visibility into budget vs. actuals across your portfolio. AI-powered forecasting detects cost overruns early so you can take corrective action before it is too late.",
    color: "text-orange-600 bg-orange-100 dark:bg-orange-900/40 dark:text-orange-400",
  },
  {
    icon: Shield,
    title: "Permitting & Regulatory Tracking",
    description: "Never miss a permit deadline or inspection milestone. Track building permits, environmental approvals, and safety compliance across all job sites in one place.",
    color: "text-yellow-700 bg-yellow-100 dark:bg-yellow-900/40 dark:text-yellow-300",
  },
];
...
const features = [
  {
    icon: Layers,
    title: "Portfolio Oversight for Capital Programs",
    description: "See every project across your construction portfolio in one view — from commercial builds and infrastructure projects to renovations and facility expansions.",
    image: networkImage,
  },
  {
    icon: AlertTriangle,
    title: "AI-Powered Risk Detection for Construction Timelines",
    description: "Our AI continuously monitors your project portfolio for schedule delays, budget overruns, and resource conflicts — alerting you before small issues become costly change orders.",
    image: dashboardImage,
  },
  {
    icon: FileCheck,
    title: "Permit & Compliance Tracking",
    description: "Track building permits, inspection milestones, environmental approvals, and safety requirements alongside your regular project tasks. Stay ahead of every regulatory requirement.",
    image: heroImage,
  },
];
...
const useCases = [
  {
    title: "Commercial Building Programs",
    description: "Plan and execute multi-phase commercial construction with task dependencies, subcontractor coordination, and automated status reporting to stakeholders.",
    icon: Building2,
  },
  {
    title: "Infrastructure Projects",
    description: "Manage road, bridge, utility, and public works projects with milestone tracking, permit management, and multi-agency coordination built in.",
    icon: MapPin,
  },
  {
    title: "Renovation & Retrofit",
    description: "Coordinate renovation programs across occupied buildings with phased rollouts, tenant communication tracking, and budget management for each scope package.",
    icon: Hammer,
  },
  {
    title: "Campus & Facility Expansions",
    description: "Oversee multi-building campus expansions with cross-project resource planning, shared milestone tracking, and executive dashboards for capital program oversight.",
    icon: TrendingUp,
  },
];
...
export default function ConstructionLandingPage() {
  ...
  const scrollToSignUp = () => {
    document.getElementById('construction-signup')?.scrollIntoView({ behavior: 'smooth' });
  };

  useEffect(() => {
    const prevTitle = document.title;
    document.title = "Construction Project Management Software | FridayReport.AI";
    ...
    const descContent = "AI-powered project portfolio management built for construction and engineering firms. Track capital programs, contractor timelines, permits, and more. Free forever.";
    upsertMeta("name", "description", descContent);
    upsertMeta("property", "og:title", "Construction Project Management Software | FridayReport.AI");
    upsertMeta("property", "og:description", "AI-powered PMO software for construction and engineering firms. Free forever.");
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="flex items-center justify-between gap-4 flex-wrap px-6 py-4 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <Badge variant="outline" className="text-xs font-medium border-yellow-300 text-yellow-700 dark:text-yellow-400 dark:border-yellow-700">
      ...
      <main>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-yellow-50 via-amber-50 to-background dark:from-yellow-950/30 dark:via-amber-950/20 dark:to-background" />
          ...
          <div className="relative px-6 md:px-12 lg:px-20 py-16 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl">
                <Badge className="mb-6 bg-yellow-100 text-yellow-800 hover:bg-yellow-100 dark:bg-yellow-900/50 dark:text-yellow-300 border-0 text-sm px-4 py-1.5">
                  <HardHat className="h-3.5 w-3.5 mr-1.5" />
                  Built for Construction & Engineering
                </Badge>
                <h1
                ...
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl">
                  From capital programs and multi-site builds to permitting and contractor management — manage your entire construction PMO with AI-powered oversight that catches risks before they become costly change orders.
                </p>
                <ul className="mt-8 space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <Check className="h-5 w-5 text-yellow-600 dark:text-yellow-400 mt-0.5 shrink-0" />
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-2xl w-full">
                <div className="relative">
                  <div className="absolute -inset-4 bg-gradient-to-r from-yellow-500/20 to-amber-500/20 rounded-2xl blur-xl" />
                  <img
                    src={heroImage}
        ...
        <section className="border-y border-border bg-muted/30">
          <div className="px-6 md:px-12 lg:px-20 py-10 max-w-[1400px] mx-auto">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground uppercase mb-6 text-center">
              Trusted by teams at leading construction & engineering organizations
            </p>
            <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
              ...
              <div className="flex items-center gap-2 opacity-60">
                ...
                <span className="text-sm font-medium text-muted-foreground">General Contractors</span>
              </div>
              <div className="flex items-center gap-2 opacity-60">
                <HardHat className="h-6 w-6 text-muted-foreground" />
                <span className="text-sm font-medium text-muted-foreground">Engineering Firms</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
          <AnimatedSection className="text-center mb-16">
            <motion.div variants={fadeUp}>
              <Badge variant="outline" className="mb-4 text-sm">Construction PMO Challenges</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                Your Construction PMO Deserves Better Tools
              </h2>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Construction firms manage dozens of concurrent job sites and hundreds of contractors. Generic project tools were not designed for the complexity of capital program delivery.
              </p>
            </motion.div>
          </AnimatedSection>
          ...
          <div className="px-6 md:px-12 lg:px-20 py-20 lg:py-28 max-w-[1400px] mx-auto">
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)" }}>
                  One Platform for Your Entire Construction Portfolio
                </h2>
                <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                  FridayReport.AI brings AI-powered portfolio management to construction, giving you the visibility and control your leadership team needs across every job site.
                </p>
              </motion.div>
            </AnimatedSection>
              ...
              {features.map((feature, i) => (
                <AnimatedSection key={i} className={cn("flex flex-col gap-10 lg:gap-16 items-center", i % 2 === 1 ? "lg:flex-row-reverse" : "lg:flex-row")}>
                  <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                    <div className="w-12 h-12 rounded-lg bg-yellow-100 dark:bg-yellow-900/40 flex items-center justify-center mb-5">
          ...
          <AnimatedSection className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {stats.map((stat, i) => (
              <motion.div key={i} variants={fadeUp} className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-amber-600 dark:from-yellow-400 dark:to-amber-400 mb-2">
                  {stat.value}
                </div>
            ...
            <AnimatedSection className="text-center mb-16">
              <motion.div variants={fadeUp}>
                ...
                <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "var(--font-display)" }}>
                  Built for the Way Construction Delivers Projects
                </h2>
                <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
                  Whether you are building a commercial complex, expanding a campus, or managing infrastructure — FridayReport.AI adapts to your workflow.
                </p>
              </motion.div>
            </AnimatedSection>
                  ...
                  <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300 h-full">
                    <CardContent className="p-8">
                      <div className="w-12 h-12 rounded-lg bg-yellow-500/20 flex items-center justify-center mb-5">
                        <useCase.icon className="h-6 w-6 text-yellow-400" />
                      </div>
          ...
          <AnimatedSection className="text-center mb-12">
            <motion.div variants={fadeUp}>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                See why construction PMOs choose FridayReport.AI over generic project management tools.
              </p>
            </motion.div>
          </AnimatedSection>
            ...
            <AnimatedSection className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <motion.div variants={fadeUp} className="flex-1 max-w-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" style={{ fontFamily: "var(--font-display)" }}>
                  Ready to Modernize Your Construction PMO?
                </h2>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Join construction and engineering firms that have already streamlined their project management with AI-powered tools designed for the unique demands of capital program delivery.
                </p>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-yellow-100 dark:bg-yellow-900/40 flex items-center justify-center shrink-0">
              ...
              <motion.div variants={fadeUp} className="flex-1 max-w-md w-full" id="construction-signup">
                <Card className="shadow-2xl border-border">
                  {emailSent ? (
                    ...
                    <>
                      <CardHeader className="text-center pb-4">
                        <div className="mx-auto w-14 h-14 rounded-full bg-yellow-100 dark:bg-yellow-900/40 flex items-center justify-center mb-4">
                          <HardHat className="h-7 w-7 text-yellow-600 dark:text-yellow-400" />
                        </div>
                        <CardTitle className="text-2xl font-bold">Start Free Today</CardTitle>
                        <CardDescription>
                          Get your construction PMO up and running in minutes
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-5">
                        <form onSubmit={handleSubmit} className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="construction-email" className="font-medium">Work Email</Label>
                            <Input
                              id="construction-email"
                              type="email"
                              placeholder="you@construction-firm.com"
                              value={email}
                          ...
                          <div className="flex items-start gap-3 p-3 rounded-md bg-muted/50 border border-border">
                            <Checkbox
                              ...
                              className="mt-0.5"
                            />
                            <Label htmlFor="construction-terms" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                              I agree to the{" "}
        ...
        <div className="px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">Construction Project Management</span>
            </div>
