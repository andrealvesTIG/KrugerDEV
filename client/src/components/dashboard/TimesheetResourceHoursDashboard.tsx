...
import { Loader2, Clock, Users, TrendingUp, Target, BarChart3, AlertCircle, CheckCircle2 } from "lucide-react";
import { ResponsiveContainer, BarChart, Bar, XAxis, YAxis, Tooltip, Legend, CartesianGrid, PieChart, Pie, Cell, RadarChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis } from "recharts";
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold">Resource Hours</h2>
          <p className="text-sm text-muted-foreground">
            Time logged by resources ({format(rangeStart, 'MMM d')} - {format(rangeEnd, 'MMM d, yyyy')})
          </p>
        </div>
