...
import {
  ...
  TrendingUp, TrendingDown, Minus, UserPlus,
} from "lucide-react";
...
export function KpiAnalyticsTab() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Platform KPI Analytics</h2>
        <p className="text-muted-foreground">
          Track all subscriber activity and platform engagement across time cohorts
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <SummaryCard
          ...
          icon={UserPlus}
          subtitle={recentCohort ? `${recentCohort.newSignups} this week` : undefined}
          trend={recentCohort && prevCohort ? getTrend(recentCohort.newSignups, prevCohort.newSignups) : undefined}
        />
        <SummaryCard
          title="Total Users"
        ...
        <SummaryCard
          ...
          value={recentCohort?.activeUsers ?? 0}
          icon={TrendingUp}
          subtitle={prevCohort ? `vs ${prevCohort.activeUsers} last week` : undefined}
          trend={recentCohort && prevCohort ? getTrend(recentCohort.activeUsers, prevCohort.activeUsers) : undefined}
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">New Signups & Active Users</CardTitle>
            <CardDescription>New subscriber registrations and active users by cohort</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={cohorts}>
                ...
                />
                <Legend />
                <Bar dataKey="newSignups" name="New Signups" fill={CHART_COLORS.newSignups} radius={[4, 4, 0, 0]} />
                <Bar dataKey="activeUsers" name="Active Users" fill={CHART_COLORS.activeUsers} radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tasks created vs completed across all organizations</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={cohorts}>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Platform Productivity</CardTitle>
            <CardDescription>Hours logged and active users platform-wide</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Feature usage and platform activity across all subscribers</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Platform Activity Breakdown by Cohort</CardTitle>
          <CardDescription>Detailed metrics across all subscribers for each time period</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <tbody>
                {cohorts.map((cohort) => (
                  <tr key={cohort.label} className="border-b last:border-0 hover:bg-muted/50">
                    ...
                    <td className="text-right py-3 px-2">{cohort.newSignups}</td>
