...
export const BUILTIN_ROLES: BuiltInRoleDef[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.PROGRAM_VIEW, PERMISSIONS.PROGRAM_MANAGE,
      ...
      PERMISSIONS.RISK_MANAGE, PERMISSIONS.ISSUE_MANAGE,
  ...
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.TASK_VIEW,
      PERMISSIONS.RESOURCE_VIEW, PERMISSIONS.RESOURCE_MANAGE,
      PERMISSIONS.REPORTS_VIEW,
    ],
  },
  {
