...
export const customFieldDefinitions = pgTable("custom_field_definitions", {
  ...
  organizationId: integer("organization_id").references(() => organizations.id).notNull(),
  name: text("name").notNull(),
  fieldType: text("field_type").notNull(), // 'text', 'number', 'percentage', 'date', 'select', 'multiselect', 'checkbox', 'url', 'autonumber', 'resource', 'attachment', 'rag', 'days_since_updated', 'days_since_created', 'effort_completed_hours', 'effort_remaining_hours', 'days_between_dates' (for days_between_dates, options stores [startDateFieldId, endDateFieldId] as strings)
