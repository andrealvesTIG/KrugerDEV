...
- **Risk Spread**: Risks without dueDate/proximity use deterministic hash-based quadrant assignment (h2 from `hashId(id+9999)`) to distribute across future/past quadrants; probability weight influences offset within quadrant; closed/mitigated risks always placed in past
