    ...
    schemas: {
      ...
      Project: {
        ...
        properties: {
          ...
          description: { type: 'string', nullable: true },
          status: { type: 'string', enum: ['Initiation', 'Planning', 'Execution', 'Monitoring', 'Closing', 'Closed'] },
          ...
          budget: { type: 'number' },
          actualCost: { type: 'number', description: 'Actual spend to date' },
          forecastCost: { type: 'number', nullable: true, description: 'Projected final cost' },
          contractTotal: { type: 'number', description: 'Total contract value for invoicing' },
          ...
          completionOverridden: { type: 'boolean', description: 'True if user manually set completion percentage' },
          ...
          source: { type: 'string', enum: ['manual', 'imported', 'planner'], description: '"manual" = created in app, "imported" = from MPP/external file, "planner" = from Microsoft Planner' },
          ...
          notes: { type: 'string', nullable: true },
          billableStatus: { type: 'string', description: 'N/A, On Track, Waiting for Approval, etc.' },
          createdAt: { type: 'string', format: 'date-time' },
          createdBy: { type: 'string', nullable: true },
      ...
      Task: {
        ...
        properties: {
          ...
          name: { type: 'string' },
          description: { type: 'string', nullable: true },
          taskType: { type: 'string', nullable: true, enum: ['Work', 'Milestone', 'Summary', 'Fixed Duration', 'Fixed Units'], description: 'Also accepts: task_type' },
          priority: { type: 'string', enum: ['Low', 'Medium', 'High', 'Critical'] },
          startDate: { type: 'string', format: 'date', description: 'Also accepts: start_date' },
          endDate: { type: 'string', format: 'date', description: 'Also accepts: end_date. Auto-calculated if durationDays is provided.' },
          ...
          durationDays: { type: 'integer', nullable: true, description: 'Duration in days. If provided with startDate, endDate is auto-calculated. Also accepts: duration_days' },
          ...
          isMilestone: { type: 'boolean', description: 'Also accepts: is_milestone' },
          isSummary: { type: 'boolean', description: 'Also accepts: is_summary' },
          isCritical: { type: 'boolean', description: 'Also accepts: is_critical' },
          ...
          notes: { type: 'string', nullable: true },
          timesheetBlocked: { type: 'boolean', description: 'Also accepts: timesheet_blocked' },
          externalId: { type: 'string', nullable: true, description: 'Also accepts: external_id' },
          completionOverridden: { type: 'boolean', description: 'True if user manually set progress' },
          createdAt: { type: 'string', format: 'date-time' },
          deletedAt: { type: 'string', format: 'date-time', nullable: true },
          deletedBy: { type: 'string', nullable: true },
          isDemo: { type: 'boolean' },
      ...
      TaskRequest: {
        type: 'object',
        description: 'Input schema for creating or updating a task. Excludes server-generated fields (id, taskNumber, wbs, timestamps, etc.). Accepts both camelCase and snake_case field names.',
        properties: {
          projectId: { type: 'integer', description: 'Also accepts: project_id' },
          name: { type: 'string' },
          description: { type: 'string', nullable: true },
      ...
      Milestone: {
        ...
        properties: {
          ...
          status: { type: 'string', enum: ['Backlog', 'To Do', 'In Progress', 'Done', 'Delayed'] },
          priority: { type: 'string', enum: ['Low', 'Medium', 'High', 'Critical'] },
      ...
      Risk: {
        ...
        properties: {
          ...
          escalatedToPortfolio: { type: 'boolean', description: 'Whether escalated to portfolio level' },
      ...
      Issue: {
        ...
        properties: {
          ...
          status: { type: 'string', enum: ['Open', 'In Progress', 'Pending', 'Resolved', 'Closed', 'Escalated'] },
          type: { type: 'string', nullable: true, enum: ['Bug', 'Enhancement', 'Task', 'Question', 'Defect', 'Support'] },
          ...
          escalatedToPortfolio: { type: 'boolean' },
          escalatedAt: { type: 'string', format: 'date-time', nullable: true },
          escalatedBy: { type: 'string', nullable: true },
          notes: { type: 'string', nullable: true },
          createdAt: { type: 'string', format: 'date-time' },
      ...
      Resource: {
        ...
        properties: {
          ...
          weeklyCapacity: { type: 'number', description: 'Hours per week available (default 40)' },
          availability: { type: 'integer', description: 'Percentage availability 0-100' },
          startDate: { type: 'string', format: 'date', nullable: true },
          endDate: { type: 'string', format: 'date', nullable: true },
          isActive: { type: 'boolean' },
          isApprover: { type: 'boolean', description: 'Can approve timesheets' },
          isIntakeApprover: { type: 'boolean', description: 'Can approve project intakes' },
          isBillable: { type: 'boolean' },
          timesheetHidden: { type: 'boolean', description: 'Hide from all timesheet dashboards' },
      ...
      ProjectIntake: {
        ...
        properties: {
          ...
          status: { type: 'string', enum: ['draft', 'in_progress', 'approved', 'rejected', 'cancelled'] },
          isBacklogComplete: { type: 'boolean' },
          basicInfoComplete: { type: 'boolean' },
          financialsComplete: { type: 'boolean' },
          projectCostComplete: { type: 'boolean' },
          cyberArchComplete: { type: 'boolean' },
          pmoSubmitted: { type: 'boolean' },
      ...
      TaskDependency: {
        ...
        properties: {
          ...
          dependencyType: { allOf: [ref('DependencyType'), { default: 'finish-to-start' }] },
      ...
      TaskDependencyCreateRequest: {
        ...
        properties: {
          ...
          dependencyType: { allOf: [ref('DependencyType'), { default: 'finish-to-start', nullable: true, description: 'Defaults to finish-to-start if omitted or null.' }] },
      ...
      TaskDependencyUpdateRequest: {
        ...
        properties: {
          dependencyType: { allOf: [ref('DependencyType'), { nullable: true, description: 'New dependency type. Null is treated as omitted.' }] },
      ...
      TaskDependencyCreateResponse: {
        ...
        properties: {
          ...
          dependencyType: { allOf: [ref('DependencyType'), { default: 'finish-to-start', description: 'The normalized dependency type.' }] },
      ...
      ChangeRequest: {
        ...
        properties: {
          ...
          type: { type: 'string', enum: ['Scope', 'Schedule', 'Budget', 'Resource', 'Quality'] },
          priority: { type: 'string', enum: ['Low', 'Medium', 'High', 'Critical'] },
          status: { type: 'string', enum: ['Draft', 'Submitted', 'Under Review', 'Approved', 'Rejected', 'Implemented'] },
