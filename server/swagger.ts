    ...
    schemas: {
      ...
      TaskDependencyCreateResponse: {
        ...
        properties: {
          ...
          dependencyType: {
            ...
            nullable: true,
            default: 'finish-to-start',
            description: 'The normalized dependency type. Typically "finish-to-start" unless specified otherwise.',
          },
          lagDays: { type: 'integer', nullable: true, default: 0, description: 'Lag/lead time in working days' },
      ...
      TaskDependencyUpdateResponse: {
        ...
        properties: {
          ...
          lagDays: { type: 'integer', nullable: true, description: 'Updated lag/lead time in working days' },
          createdAt: { type: 'string', format: 'date-time', nullable: true },
          propagatedTasks: {
            type: 'array',
