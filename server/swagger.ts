    ...
    schemas: {
      ...
      Project: {
        ...
        properties: {
          ...
          description: { type: 'string', nullable: true },
          status: { type: 'string', enum: ['Initiation', 'Planning', 'Execution', 'Monitoring', 'Closing', 'Billing', 'On Hold', 'Cancelled', 'Closed'] },
          ...
          deletedBy: { type: 'string', nullable: true },
          isDemo: { type: 'boolean' },
          isInternal: { type: 'boolean', description: 'Internal project flag' },
      ...
      Task: {
        ...
        properties: {
          ...
          isOngoing: { type: 'boolean', description: 'Ongoing/operational task without scheduled dates. Also accepts: is_ongoing' },
      ...
      MilestoneRequest: {
        type: 'object',
        description: 'Request body for creating or updating a task milestone (legacy milestones table).',
        properties: {
          projectId: { type: 'integer' },
          milestoneNumber: { type: 'string', nullable: true },
          title: { type: 'string' },
      ...
      ProjectIntakeRequest: {
        ...
        properties: {
          ...
          capitalExpense: { type: 'number', nullable: true },
          operatingExpense: { type: 'number', nullable: true },
          ...
          itCostEstimate: { type: 'number', nullable: true },
