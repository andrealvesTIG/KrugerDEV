    ...
    schemas: {
      ...
      Project: {
        ...
        properties: {
          ...
          source: { type: 'string', default: 'manual', enum: ['manual', 'imported', 'planner', 'planner_premium'], description: '"manual" = created in app, "imported" = from MPP/external file, "planner" = from Microsoft Planner (Graph), "planner_premium" = from Planner Premium / Dataverse' },
      ...
      Resource: {
        ...
        properties: {
          ...
          resourceType: { type: 'string', nullable: true, enum: ['Employee', 'Contractor', 'Vendor', 'Equipment', 'Material'], description: 'Resource classification' },
      ...
      Document: {
        ...
        properties: {
          ...
          title: { type: 'string' },
          description: { type: 'string', nullable: true },
          type: { type: 'string', enum: ['Charter', 'Plan', 'Requirements', 'Design', 'Test', 'Training', 'General'], description: 'Document classification' },
      ...
      ProjectBenefit: {
        ...
        properties: {
          ...
          name: { type: 'string' },
          description: { type: 'string', nullable: true },
          category: { type: 'string', nullable: true, description: 'Financial, Operational, Strategic, Customer, etc.' },
          benefitType: { type: 'string', nullable: true, description: 'Tangible or Intangible' },
          measurementMethod: { type: 'string', nullable: true, description: 'How the benefit is measured' },
          unit: { type: 'string', nullable: true, description: 'Currency, Percentage, Number, etc.' },
          targetValue: { type: 'string', nullable: true, description: 'Expected/target value (numeric stored as string)' },
          actualValue: { type: 'string', nullable: true, description: 'Realized/actual value (numeric stored as string)' },
          baselineValue: { type: 'string', nullable: true, description: 'Value before project (numeric stored as string)' },
          targetDate: { type: 'string', format: 'date', nullable: true, description: 'When benefit should be realized' },
          actualRealizationDate: { type: 'string', format: 'date', nullable: true },
          status: { type: 'string', default: 'Planned', enum: ['Planned', 'In Progress', 'Partially Realized', 'Fully Realized', 'Not Achieved'] },
          owner: { type: 'string', nullable: true, description: 'User ID of benefit owner' },
          notes: { type: 'string', nullable: true },
          isDemo: { type: 'boolean', default: false },
          createdAt: { type: 'string', format: 'date-time' },
          createdBy: { type: 'string', nullable: true },
      ...
      ProjectDecision: {
        ...
        properties: {
          ...
          title: { type: 'string' },
          description: { type: 'string', nullable: true },
          decisionType: { type: 'string', nullable: true, description: 'Strategic, Financial, Resource, Risk, Scope, etc.' },
          status: { type: 'string', default: 'Pending', enum: ['Pending', 'Approved', 'Rejected', 'Deferred', 'Implemented'] },
          rationale: { type: 'string', nullable: true, description: 'Why this decision was made' },
          alternatives: { type: 'string', nullable: true, description: 'Alternatives considered' },
          impact: { type: 'string', nullable: true, description: 'Expected impact of the decision' },
          riskAssessment: { type: 'string', nullable: true, description: 'Risks associated with the decision' },
          stakeholders: { type: 'string', nullable: true, description: 'Key stakeholders involved' },
          decisionDate: { type: 'string', format: 'date', nullable: true },
          implementationDate: { type: 'string', format: 'date', nullable: true },
          reviewDate: { type: 'string', format: 'date', nullable: true, description: 'When to review the decision' },
          outcome: { type: 'string', nullable: true, description: 'Actual outcome after implementation' },
          decisionMaker: { type: 'string', nullable: true, description: 'User ID of decision maker' },
      ...
      LessonLearned: {
        ...
        properties: {
          ...
          type: { type: 'string', default: 'Improvement' },
          lessonType: { type: 'string', default: 'Positive', description: 'Positive or Negative' },
          impact: { type: 'string', nullable: true },
          phase: { type: 'string', nullable: true },
          rootCause: { type: 'string', nullable: true },
          recommendation: { type: 'string', nullable: true },
          outcome: { type: 'string', nullable: true },
          actionsTaken: { type: 'string', nullable: true },
          applicability: { type: 'string', nullable: true },
          tags: { type: 'string', nullable: true },
          attachments: { type: 'string', nullable: true },
          isShared: { type: 'boolean', default: false },
          status: { type: 'string', default: 'Draft' },
          dateIdentified: { type: 'string', format: 'date', nullable: true },
          identifiedBy: { type: 'string', nullable: true },
          reviewedBy: { type: 'string', nullable: true },
      ...
      TimesheetPeriod: {
        ...
        properties: {
          ...
          closedBy: { type: 'string', nullable: true, description: 'User ID who closed the period' },
          closedAt: { type: 'string', format: 'date-time', nullable: true },
          reopenedBy: { type: 'string', nullable: true, description: 'User ID who reopened the period' },
      ...
      ProjectView: {
        ...
        properties: {
          ...
          organizationId: { type: 'integer' },
          userId: { type: 'string' },
          mode: { type: 'string', enum: ['grid', 'gantt'], description: 'View mode' },
          name: { type: 'string' },
          isDefault: { type: 'boolean', default: false, description: 'User default view for this mode' },
          isSystem: { type: 'boolean', default: false, description: 'System default view (cannot be deleted)' },
          visibleColumns: { type: 'array', items: { type: 'string' }, description: 'Column keys visible in the view' },
          columnOrder: { type: 'array', items: { type: 'string' }, nullable: true },
          columnWidths: { type: 'object', nullable: true, description: 'Map of column key to pixel width' },
          frozenColumns: { type: 'array', items: { type: 'string' }, nullable: true },
          createdAt: { type: 'string', format: 'date-time' },
          updatedAt: { type: 'string', format: 'date-time' },
        },
        required: ['id', 'organizationId', 'userId', 'mode', 'name', 'visibleColumns'],
      },
      ProjectTemplate: {
        type: 'object',
        properties: {
          ...
          name: { type: 'string' },
          description: { type: 'string', nullable: true },
          sourceType: { type: 'string', default: 'project', description: 'How template was created: "project" (from existing project) or "file" (from uploaded file)' },
          originalFileName: { type: 'string', nullable: true, description: 'Original uploaded file name' },
          storedFileUrl: { type: 'string', nullable: true, description: 'URL to stored template file' },
          itemCount: { type: 'integer', default: 0, description: 'Number of tasks/items in the template' },
          milestoneCount: { type: 'integer', default: 0, description: 'Number of milestones in the template' },
          sourceProjectId: { type: 'integer', nullable: true, description: 'ID of the project this template was created from' },
          createdBy: { type: 'string', nullable: true },
          createdAt: { type: 'string', format: 'date-time' },
          updatedAt: { type: 'string', format: 'date-time' },
        },
        required: ['id', 'organizationId', 'name'],
        example: { id: 1, organizationId: 1, name: 'Agile Sprint Template', description: 'Standard 2-week sprint', sourceType: 'project', itemCount: 15, milestoneCount: 3 },
      },
      TimesheetAuditLog: {
        type: 'object',
        properties: {
      ...
      TimesheetReminderSettings: {
        ...
        properties: {
          ...
          submissionReminderDays: { type: 'object', nullable: true, description: 'JSON object configuring which days before period end to send submission reminders' },
      ...
      TimesheetSettings: {
        ...
        properties: {
          id: { type: 'integer' },
          organizationId: { type: 'integer' },
          minWeeklyHours: { type: 'string', description: 'Numeric value stored as string (default "0")' },
          maxWeeklyHours: { type: 'string', description: 'Numeric value stored as string (default "50")' },
          overtimeThreshold: { type: 'string', description: 'Numeric value stored as string (default "40")' },
          gracePeriodDays: { type: 'integer', default: 0 },
          mandatoryNotes: { type: 'boolean', default: true },
          createdAt: { type: 'string', format: 'date-time' },
          updatedAt: { type: 'string', format: 'date-time' },
        },
        required: ['organizationId'],
  ...
  paths: {
    ...
    '/projects/{projectId}/benefits': {
      get: op('Scoring & Benefits', 'List project benefits', {
        parameters: [pathId('projectId')],
        responses: { ...r200('Benefits list', arrOf('ProjectBenefit')), ...idRes },
      }),
      post: op('Scoring & Benefits', 'Add project benefit', {
        parameters: [pathId('projectId')],
        requestBody: body(ref('ProjectBenefit')),
        responses: { ...r201('Benefit added', ref('ProjectBenefit')), ...createRes },
      }),
    },
    '/project-benefits/{id}': {
      put: op('Scoring & Benefits', 'Update project benefit', {
        parameters: [pathId()],
        requestBody: body(ref('ProjectBenefit'), false),
        responses: { ...r200('Benefit updated', ref('ProjectBenefit')), ...updateRes },
      }),
    ...
    '/projects/{projectId}/decisions': {
      get: op('Scoring & Benefits', 'List project decisions', {
        parameters: [pathId('projectId')],
        responses: { ...r200('Decisions list', arrOf('ProjectDecision')), ...idRes },
      }),
      post: op('Scoring & Benefits', 'Add project decision', {
        parameters: [pathId('projectId')],
        requestBody: body(ref('ProjectDecision')),
        responses: { ...r201('Decision added', ref('ProjectDecision')), ...createRes },
      }),
    },
    '/project-decisions/{id}': {
      put: op('Scoring & Benefits', 'Update project decision', {
        parameters: [pathId()],
        requestBody: body(ref('ProjectDecision'), false),
        responses: { ...r200('Decision updated', ref('ProjectDecision')), ...updateRes },
      }),
    ...
    '/projects/{projectId}/lessons-learned': {
      get: op('Scoring & Benefits', 'List lessons learned for project', {
        parameters: [pathId('projectId')],
        responses: { ...r200('Lessons learned', arrOf('LessonLearned')), ...idRes },
      }),
      post: op('Scoring & Benefits', 'Add lesson learned', {
        parameters: [pathId('projectId')],
        requestBody: body(ref('LessonLearned')),
        responses: { ...r201('Lesson added', ref('LessonLearned')), ...createRes },
      }),
    },
    '/organizations/{organizationId}/lessons-learned': {
      get: op('Scoring & Benefits', 'List all lessons learned for organization', {
        parameters: [pathId('organizationId')],
        responses: { ...r200('All lessons learned', arrOf('LessonLearned')), ...idRes },
      }),
    },
    '/lessons-learned/{id}': {
      put: op('Scoring & Benefits', 'Update lesson learned', {
        parameters: [pathId()],
        requestBody: body(ref('LessonLearned'), false),
        responses: { ...r200('Lesson updated', ref('LessonLearned')), ...updateRes },
      }),
